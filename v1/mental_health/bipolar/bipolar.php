    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">Bipolar</a></li>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Bipolar disorder, also known as Manic Depressive Disorder or Manic Depression, is characterized by extreme
                mood swings from mania to depression. Bipolarism can be difficult to diagnose because each individual
                displays the high and low episodes differently, with varying levels of severity. Mania is identified by
                an increasingly relentless high-flying mood that can spiral into a period of dark depression. During
                times of mania, individuals often engage in risky behavior such as lavish spending sprees or risky sexual
                contact. As an individual switches from a period of mania to depression they often feel hopeless,
                worthlessness and a severe loss of energy. Bipolarism is caused by an imbalance in brain chemistry
        ...
        <div class="col-sm-6">
            ...
            <h4>Bipolar Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About Bipolar</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with this bipolar.
...
<div id="blog"  class="text-center">
    ...
    <div class="boom">
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="Bipolar" ORDER BY id ASC');
...
<div id="comment">
    ...
    <div id="chat-wrap">
        ...
        <p>
            ...
            is if all agree to be supportive community members and adhere to the community rules. No attacks against someone’s
            ...
            Do not use multiple usernames. Do not use inappropriate language. Do not provoke or “troll” anyone. Engaging
            in the Cherishing Minds community in the manner will result in your IP address being blocked and you will
            never be able to chat on Cherishing Minds again. This behavior is not conducive to building a positive,
