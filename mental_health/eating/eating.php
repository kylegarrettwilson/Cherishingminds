    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">Eating</a></li>
        ...
        <div class="caption">
            <div class="caption-wrapper">
                <div class="caption-info">
                    ...
                    <h1 id="header">Eating Disorders</h1>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Eating disorders is an all-encompassing term that refers to disorders that are marked by an unhealthy
                relationship with food. Anorexia Nervosa and Bulimia Nervosa are the two prevalent diseases commonly
                referred to as eating disorders. Individuals who struggle with Anorexia are obsessively concerned with
                feeling or looking “fat”.  They combat this by not eating to the point of starvation and/or excessive exercise.
                Bulimia is a condition that is marked by individuals entering into a cycle of binge eating followed by
                purging of the food. Each condition is characterized by excessive worry over weight loss and physical appearance.
                Eating disorders can manifest themselves as a way for people to control specific aspects of their life, mainly
                food, when everything else seems to be out of their control.
            </p>
        ...
        <div class="col-sm-6">
            ...
            <h4>Eating Disorders Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About Eating Disorders</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with eating disorders.
...
<div id="blog"  class="text-center">
    ...
    <div class="boom">
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="Eating" ORDER BY id ASC');
