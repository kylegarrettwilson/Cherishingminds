    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">ADD/ADHD</a></li>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Attention Deficit Hyperactivity Disorder, or ADHD, is a condition with symptoms such as hyperactivity
                and a lack of focus. ADHD was formerly known as Attention Deficit Disorder or ADD.  Adults who have
                ADHD may begin to show symptoms as a child that continues into adulthood. Both children and adults
                with ADHD may have a hard time being organized, setting goals and managing schedules. Studies show
                that the disease may be genetically transmitted and is caused by an imbalance or deficiency in certain
                chemicals related to brain function. Although the exact cause of ADHD is still unknown, it is often
                successfully treated with medication and is non-life threatening.
            </p>
        ...
        <div class="col-sm-6">
            ...
            <h4>ADD & ADHD Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About ADHD/ADD</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with ADHD. This is
                    in no way a list of all symptoms and every person displays symptoms differently.  Consult with a
                ...
                <ul>
                    ...
                    <li>
                        Tendency to make rushed decisions
                    </li>
                    <li>
...
<div id="blog"  class="text-center">
    ...
    <h1>Lets Connect!</h1>
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="ADHD" ORDER BY id ASC');
...
<div id="comment">
    ...
    <div id="chat-wrap">
        ...
        <p>
            We are here to build a community that revolves around positivity and acceptance. The only way we can do
            this is if all agree to be supportive community members and adhere to the community rules. No attacks
            against someone’s race, religion, politics, sex, sexual orientation, etc. No acts of harassment, including
            but not limited to violent or sexual nature. We are not all code interpreters; please refrain from using
            abbreviations and short hand text in order for everyone to understand what you are saying. There will be
            no solicitation of any kind. Do not use multiple usernames. Do not use inappropriate language. Do not
            provoke or “troll” anyone. Engaging in the Cherishing Minds community in the manner will result in your
            IP address being blocked and you will never be able to chat on Cherishing Minds again. This behavior is
            not conducive to building a positive, supportive community. Ultimately, be respectful.
        </p>
