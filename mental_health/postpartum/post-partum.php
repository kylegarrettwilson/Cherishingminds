    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">Post-Partum</a></li>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Postpartum Depression is characterized by major depression that is brought on following the birth of a
                child. Postpartum depression exhibits all of the symptoms of a major depressive state, however, rather
                than a natural imbalance in brain chemistry, it is widely accepted that an imbalance is primarily hormonal
                related. Postpartum depression can be exacerbated by a sick or colicky baby, other stresses in life, and
                lack of support post birth. Women with postpartum depression often describe their state of mind as hopeless
                and empty with a loss of passion for once pleasurable tasks. Postpartum depression responds well to
                antidepressants and is often not a lifelong ailment.
            </p>
        ...
        <div class="col-sm-6">
            ...
            <h4>Postpartum Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About Postpartum</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    ...
                    content are provided on an “as is” basis, with some screening to promote your safety and to meet
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with postpartum depression.
                ...
                <ul>
                    ...
                    <li>
                        Trouble feeling close to your baby
                    </li>
                    <li>
                        Inability to take care of yourself or baby
                    </li>
                    <li>
...
<div id="blog"  class="text-center">
    ...
    <div class="boom">
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="Partum" ORDER BY id ASC');
...
<div id="comment">
    ...
    <div id="chat-wrap">
        ...
        <p>
            We are here to build a community that revolves around positivity and acceptance. The only way we can do this is
            if all agree to be supportive community members and adhere to the community rules. No attacks against someone’s
            race, religion, politics, sex, sexual orientation, etc. No acts of harassment, including but not limited to
            violent or sexual nature. We are not all code interpreters; please refrain from using abbreviations and short
            hand text in order for everyone to understand what you are saying. There will be no solicitation of any kind.
            Do not use multiple usernames. Do not use inappropriate language. Do not provoke or “troll” anyone. Engaging in
            the Cherishing Minds community in the manner will result in your IP address being blocked and you will never be
            able to chat on Cherishing Minds again. This behavior is not conducive to building a positive, supportive
            community. Ultimately, be respectful.
        </p>
