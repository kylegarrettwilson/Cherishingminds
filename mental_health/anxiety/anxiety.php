    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">Anxiety</a></li>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Although anxiety is a normal occurrence throughout our busy lives, the disease interferes with your
                ability to lead a normal life. Anxiety is considered one of the more severe mental illnesses and can be
                disabling. As with many, if not all, mental diseases, scientific studies show that it is linked to an
                imbalance in brain chemistry. Because of this, many patients respond well to both cognitive therapy and
                prescription medication. It is important to know that anxiety is an all-encompassing term for several
                different types of disorders such as social anxiety and specific phobias.
            </p>
        ...
        <div class="col-sm-6">
            ...
            <h4>Anxiety Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About Anxiety</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    ...
                    This site may contain health related materials regarding intimacy and intimate relationships.
                    If you find this offensive, you may not find this site appropriate to meet your needs. This site
                    and its content are provided on an “as is” basis, with some screening to promote your safety and
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with anxiety.
                ...
                <ul>
                    ...
                    <li>
                        Inability to stay calm or be still
                    </li>
                    <li>
                        Dry mouth
                    </li>
...
<div id="blog"  class="text-center">
    ...
    <div class="boom">
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="Anxiety" ORDER BY id ASC');
