    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">PTSD</a></li>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Post Traumatic Stress Disorder, also known as PTSD or “shell shock” is a serious mental health condition
                that is developed after an individual experience a traumatic or terrifying event. Most people who experience
                a traumatic event will experience feelings of shock, anger and fear. Typically, these feelings subside over
                time and become nothing more than a memory. However, for people with PTSD, these feelings do not go away
                and may become so strong that the experience is continually relived. PTSD can be debilitating and make it
                impossible to live a normal life. Symptoms of PTSD often begin to show within three months of the
                traumatic event.  The goal of PTSD treatment is to diminish the emotional and physical symptoms in
                order to help the patient better cope with the event. Most treatment evolves both cognitive retraining
        ...
        <div class="col-sm-6">
            ...
            <h4>PTSD Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About PTSD</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with PTSD.
                ...
                <ul>
                    <li>
                        Everyday stimuli causes reliving of the traumatic event
                    </li>
                    <li>
                        Hypervigilance
                    </li>
...
<div id="blog"  class="text-center">
    ...
    <div class="boom">
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="PTSD" ORDER BY id ASC');
