    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">Depression</a></li>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Sadness and feeling depressed is a natural human emotion that we all experience at one time or another.
                Depression is a normal reaction to many of life’s most difficult experiences and challenging circumstances.
                However, depression can spin out of control and enter into a realm where professional intervention is
                necessary. A key sign that a person has entered into the diseased state of depression is when their mood
                is chronically depressed and/or they have a loss of interest in activities that once were enjoyable.
                Typically, these signs must be present for most of the day and last two weeks. Chronic depression is
                considered to be caused by a chemical imbalance in the brain and does respond well to medication.
            </p>
        ...
        <div class="col-sm-6">
            ...
            <h4>Depression Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About Depression</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with depression. This
                    is in no way a list of all symptoms and every person displays symptoms differently. Consult with a doctor for a proper diagnosis.
                </p>
...
<div id="blog"  class="text-center">
    ...
    <div class="boom">
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="Depression" ORDER BY id ASC');
