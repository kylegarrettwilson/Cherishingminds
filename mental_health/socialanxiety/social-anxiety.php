    ...
    <div class="container">
        ...
        <div class="navbar-collapse  collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active scroll"><a href="#home">Social Anxiety</a></li>
        ...
        <div class="caption">
            <div class="caption-wrapper">
                <div class="caption-info">
                    ...
                    <h1 id="header">Social Anxiety</h1>
...
<div id="menu"  class="container spacer about">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h4>What is it?</h4>
            <p>
                Social Anxiety is a subcategory of Generalized Anxiety Disorder in which a person has a phobia of social
                situations, often manifesting in an irrational fear of making mistakes or embarrassing themselves in front
                of others. This fear may be heightened by a lack of social skills and/or experience with other people.
                Individuals with Social Anxiety often suffer from “anticipatory” anxiety in which they fear the upcoming
                experience before the event occurs. To negatively reinforce the anxiety, people struggling with “anticipatory”
                anxiety may avoid the event all together, which continues to perpetuate the phobia. Social Anxiety is
                often treated with a combination of cognitive and medicinal rehabilitation.
            </p>
        ...
        <div class="col-sm-6">
            ...
            <h4>Social Anxiety Weekly Meeting Schedule</h4>
...
<div id="mental-health">
    ...
    <div class="container spacer about">
        <h2 class="text-center">Details About Social Anxiety</h2>
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p>
                    These are generalized symptoms that may be expressed in an individual afflicted with social anxiety.
                ...
                <ul>
                    ...
                    <li>
                        Concern that one will offend someone
                    </li>
                    <li>
                    ...
                    <li>
                        Avoiding situations in which one may be the center of attention
                    </li>
                    <li>
                        Expecting the worst possible consequences from a negative experience during social situations
                    </li>
                </ul>
...
<div id="blog"  class="text-center">
    ...
    <div class="boom">
        ...
        $stmt = $dbh->prepare('SELECT * FROM blog WHERE category="Social" ORDER BY id ASC');
